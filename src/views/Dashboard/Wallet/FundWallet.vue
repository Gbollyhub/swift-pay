  ...
  <div>
    <div v-show="fundView">
      <div class="fund-top-nav mt-4">
        <h4 style="color: #1c1c1c" class="fund-header">Fund your wallet</h4>
      </div>
      <br />
      <div style="text-align: center">
        ...
        <input
          ...
          style="width: 100%"
        />
        <span style="font-size: 13px; color: #a1a1a1">₦{{ amount }}</span>
        <br />
      </div>
      <br /><br /><br />
      ...
      <div class="paymentMethod">
        ...
        <div @click="cardSelected" class="paymentMethod-div">
          <v-icon v-show="isCard" small color="#1c1c1c" class="select-icon"
            >mdi-check-circle</v-icon
          >
          <v-icon style="float: left; margin-right: 10px" small color="#1c1c1c"
        ...
        <div class="paymentMethod-div" v-show="isCard">
          <div>
            <label for="card-card" class="form-label">Enter Card Number</label
            ><br />
            <input
              maxlength="19"
              name="text1"
              class="form-field"
              type="text"
              placeholder="555 8955 7894 8595"
              required
            />
            <div class="form-icon-mastercard mastercard">
              <img
                class="form-icon-svg"
            ...
            <div class="form-icon-visa verve">
              <img
                class="form-icon-svg"
          ...
          <div>
            ...
            <input
              onkeypress="return checkCcv(event)"
              type="text"
              maxlength="3"
              class="form-field"
              id="cvv"
        ...
        <div @click="ussdSelected" class="paymentMethod-div">
          <v-icon v-show="isUssd" small color="#1c1c1c" class="select-icon"
            >mdi-check-circle</v-icon
          >
          <v-icon style="float: left; margin-right: 10px" small color="#1c1c1c"
    ...
    <div v-show="successView">
      <div class="justify-center">
        <div class="Form-heading" style="text-align: center; padding-top: 30%">
          <v-icon class="success-icon" style="font-size: 40px"
            >mdi-check-circle</v-icon
          >
          <br />
    ...
    <div v-show="failedView">
      <div class="justify-center">
        <div class="Form-heading" style="text-align: center; padding-top: 30%">
          <v-icon style="color: #bd161c; font-size: 100px"
            >mdi-alert-circle</v-icon
          >
          <br />
          <h1
            class="header-text"
            style="text-transform: capitalize; font-size: 20px"
          >
            {{ error }}
          </h1>
          <br /><br />
