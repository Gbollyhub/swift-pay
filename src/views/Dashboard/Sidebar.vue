    ...
    <nav class="navigation">
      <ul class="mainmenu">
        <li class="mainmenu-li">
          <a href="/"><v-icon class="nav-icon">mdi-home</v-icon>Overview</a>
        </li>
        <li class="mainmenu-li">
          <a href="/transactions"
            ><v-icon class="nav-icon">mdi-bank-transfer</v-icon>Transactions</a
          >
        </li>
        <li class="mainmenu-li">
          <a href="/settings"
            ><v-icon class="nav-icon">mdi-cog</v-icon>Settings</a
          >
        </li>
        <li @click="logout" class="mainmenu-li">
          <a href="#"><v-icon class="nav-icon">mdi-power</v-icon>Logout</a>
        </li>
      </ul>
    </nav>
  </div>
